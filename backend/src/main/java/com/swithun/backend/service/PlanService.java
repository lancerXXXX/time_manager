...
public class PlanService {
  ...
  public Map<String, Object> dealWithGetAllLimitedPlan(String date) {
    ...
    // 1. 处理 时间限制 计划
    logger.warn("ufPlans总共" + ufPlans.size());
    ...
    logger.warn("tPlan总共" + tPlans.size());
  ...
  public void addtask(addTaskDTO dto) {
    ...
    logger.info("时间" + dto.getTime());
    logger.info("时间" + plan.getTime());
